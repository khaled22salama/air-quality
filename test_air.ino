...
const char* ssid = "Khaled Salama";               // Wifi SSID
const char* password = "12345678";           // Wifi Password
const char* username = "ks";          // my AskSensors username
const char* pubTopic = "publish /ks/lwzEWnQgjzbQriIB82FK8GW6EPwxTDa8";  // publish/username/apiKeyIn
